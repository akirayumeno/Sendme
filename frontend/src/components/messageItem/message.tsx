...
import { Check, Copy, FileImage, Monitor, Smartphone, File, Download, ExternalLink } from "lucide-react";
import type {FileMessage, ImageMessage, Message, TextMessage, ThemeConfig} from "../../types/type.tsx";
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 ml-3">
                <a
                  href={message.fileItem.url}
                  download={message.fileItem.name}
